...
import "../src/SubnetActorDiamondRegistry.sol";

contract SubnetActorDiamondRegistryTest is Test {
    ...
    SubnetActorDiamondRegistry sr;

    function setUp() public {
        sr = new SubnetActorDiamondRegistry(DEFAULT_IPC_GATEWAY_ADDR);
    }

    function testSubnetActorDiamondRegistry_Registry_Deployment_Works() public {
    ...
    function _assertDeploySubnetActor(
        ...
        sr.newSubnetActorDiamond(params);
