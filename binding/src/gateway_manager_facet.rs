...
pub mod gateway_manager_facet {
    ...
    impl ::ethers::core::abi::AbiDecode for GatewayManagerFacetCalls {
        fn decode(
            ...
            if let Ok(decoded) = <NewMembershipCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
            ...
            if let Ok(decoded) = <ReleaseAmountCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
