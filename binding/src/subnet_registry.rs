...
pub mod subnet_registry {
    ...
    impl<M: ::ethers::providers::Middleware> SubnetRegistry<M> {
        ...
        ///Calls the contract's `newSubnetActor` (0x619ca868) function
        pub fn new_subnet_actor(
            &self,
            params: ConstructorParams,
        ) -> ::ethers::contract::builders::ContractCall<M, ::ethers::core::types::Address> {
            self.0
                .method_hash([97, 156, 168, 104], (params,))
                .expect("method not found (this should never happen)")
        }
    ...
    ///Container type for all input parameters for the `newSubnetActor` function with signature `newSubnetActor(((uint64,address[]),bytes32,address,uint8,uint256,uint64,uint64,uint8,uint16,uint8,uint256))` and selector `0x619ca868`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    #[ethcall(
        name = "newSubnetActor",
        abi = "newSubnetActor(((uint64,address[]),bytes32,address,uint8,uint256,uint64,uint64,uint8,uint16,uint8,uint256))"
    )]
    ...
    ///Container type for all return fields from the `newSubnetActor` function with signature `newSubnetActor(((uint64,address[]),bytes32,address,uint8,uint256,uint64,uint64,uint8,uint16,uint8,uint256))` and selector `0x619ca868`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
        ::ethers::contract::EthAbiCodec,
    ...
    ///`ConstructorParams((uint64,address[]),bytes32,address,uint8,uint256,uint64,uint64,uint8,uint16,uint8,uint256)`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
        ::ethers::contract::EthAbiCodec,
    ...
    pub struct ConstructorParams {
        ...
        pub power_scale: u8,
        pub relayer_reward: ::ethers::core::types::U256,
    }
