...
pub mod subnet_registry {
    ...
    impl<M: ::ethers::providers::Middleware> SubnetRegistry<M> {
        ...
        ///Calls the contract's `newSubnetActor` (0x1e672263) function
        ...
        > {
            self.0
                .method_hash([30, 103, 34, 99], (params,))
                .expect("method not found (this should never happen)")
        }
    ...
    ///Container type for all input parameters for the `newSubnetActor` function with signature `newSubnetActor(((uint64,address[]),bytes32,address,uint8,uint256,uint64,uint64,uint8,uint16))` and selector `0x1e672263`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    #[ethcall(
        name = "newSubnetActor",
        abi = "newSubnetActor(((uint64,address[]),bytes32,address,uint8,uint256,uint64,uint64,uint8,uint16))"
    )]
    ...
    ///Container type for all return fields from the `newSubnetActor` function with signature `newSubnetActor(((uint64,address[]),bytes32,address,uint8,uint256,uint64,uint64,uint8,uint16))` and selector `0x1e672263`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
        ::ethers::contract::EthAbiCodec,
    ...
    ///`ConstructorParams((uint64,address[]),bytes32,address,uint8,uint256,uint64,uint64,uint8,uint16)`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
        ::ethers::contract::EthAbiCodec,
